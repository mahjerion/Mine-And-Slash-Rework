...
// ItemReqs.Datas.SEED_USES max-uses counter (all 16 currencies key off the same "seed_uses" NBT
...
public class ImprisonedMonsterCurrencies extends ExileKeyHolderSection<ExileCurrencies> {
    ...
    public ExileKey<ExileCurrency, IdKey> SHELL_SEED = seed("shell_seed", "Shell Seed", SlotTags.offhand_family, ItemMods.INSTANCE.ADD_20_POTENTIAL, IRarity.RARE_ID);
    ...
    public ExileKey<ExileCurrency, IdKey> PERFECTED_SHELL_SEED = seed("perfected_shell_seed", "Perfected Shell Seed", SlotTags.offhand_family, ItemMods.INSTANCE.ADD_50_POTENTIAL, IRarity.LEGENDARY_ID);
    ...
    public List<ExileKey<ExileCurrency, IdKey>> BASE_SEEDS = List.of(
            MIGHT_SEED, MIND_SEED, HEART_SEED, ROOT_SEED, STRIDE_SEED, SOUL_SEED, BOND_SEED, SHELL_SEED);
    public List<ExileKey<ExileCurrency, IdKey>> PERFECTED_SEEDS = List.of(
            ...
            PERFECTED_STRIDE_SEED, PERFECTED_SOUL_SEED, PERFECTED_BOND_SEED, PERFECTED_SHELL_SEED);

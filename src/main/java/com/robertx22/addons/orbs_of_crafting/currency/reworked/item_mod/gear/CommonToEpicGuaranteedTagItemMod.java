...
public class CommonToEpicGuaranteedTagItemMod extends GearModification {
    ...
    public CommonToEpicGuaranteedTagItemMod(String id, Data data) {
        super(ItemModificationSers.COMMON_TO_EPIC_GUARANTEED_TAG, id);
        this.data = data;
    }
    ...
    public Class<?> getClassForSerialization() {
        return CommonToEpicGuaranteedTagItemMod.class;
    }
    ...
    public TranslationBuilder createTranslationBuilder() {
        return TranslationBuilder.of(SlashRef.MODID)
                .desc(ExileTranslation.registry(this, "Turns Common Item into Epic Item and guarantees an Epic affix with a specific tag"));
    }
}
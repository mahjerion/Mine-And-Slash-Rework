...
import com.robertx22.mine_and_slash.uncommon.effectdatas.rework.action.*;
...
public class StatEffects implements ExileRegistryInit {
    ...
    public static class Layers {
        ...
        public static ModifyStatLayerEffect DOT_DAMAGE_MULTI = new ModifyStatLayerEffect("", StatLayers.Offensive.DOT_DMG_MULTI, EventData.NUMBER, ModifyStatLayerEffect.ModificationType.ADD, NumberProvider.ofStatData());
        ...
        public static ModifyStatLayerEffect ADDITIVE_FLAT_MANA_FROM_MANA = new ModifyStatLayerEffect("mana_inc_", StatLayers.Offensive.FLAT_DAMAGE, EventData.NUMBER, ModifyStatLayerEffect.ModificationType.ADD, NumberProvider.ofPercentOfStat(Mana.getInstance().GUID()));
    ...
    public static StatEffect ADD_TOTEM_COUNT = new AddToNumberEffect("add_totem_count", EventData.EXTRA_TOTEMS, NumberProvider.ofStatData());

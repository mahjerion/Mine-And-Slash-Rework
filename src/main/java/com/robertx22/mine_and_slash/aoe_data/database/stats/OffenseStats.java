...
import static com.robertx22.mine_and_slash.database.data.stats.Stat.format;
...
public class OffenseStats {
    ...
    public static DataPackStatAccessor<EmptyAccessor> ARCHMAGE_BONUS_MANA_DAMAGE = DatapackStatBuilder
            ...
            .setSide(EffectSides.Source)
            .addCondition(StatConditions.SPELL_HAS_RESOURCE_TYPE_COST.get(ResourceType.mana))

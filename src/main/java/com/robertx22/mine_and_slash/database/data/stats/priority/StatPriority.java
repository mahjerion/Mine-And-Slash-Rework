...
public class StatPriority implements IAutoLocName {
    ...
    public interface Damage {
        ...
        StatPriority AFTER_DAMAGE_LAYERS = damage("AFTER_DAMAGE_LAYERS", 21); // this one contains a bunch of its own ordered multipliers
        ...
        StatPriority AFTER_CALC_LAYER = damage("AFTER_CALC_LAYER", 31); // for stuff like leech, because we don't want absorbs, mana shields etc to stop leech

...
public class BonusFlatMagicElementalDamage extends ElementalStat {
    ...
    public BonusFlatMagicElementalDamage(Elements element) {
        super(element);
    ...
    public Stat newGeneratedInstance(Elements element) {
        return new BonusFlatMagicElementalDamage(element);
    }
    ...
    public String locDescLangFileGUID() {
        return SlashRef.MODID + ".stat_desc." + "ele_added_magic_dmg";
    }

    @Override
    public String locNameForLangFile() {
        return "Added " + getElement().dmgName + " Damage to Magic Skills";
    }

    @Override
    public String locDescForLangFile() {
        return "Adds x element damage on hit with a Magic Skill. It's multiplied by damage effectiveness of the hit.";
    }

    @Override
    public String GUID() {
        return "flat_" + this.getElement().guidName + "_added_magic_damage";
    }
    ...
    private static class Effect extends BaseDamageEffect {
        ...
        public boolean canActivate(DamageEvent effect, StatData data, Stat stat) {
            return effect.data.getAttackType().isHit()
                    ...
                    && effect.isSpell()
                    && effect.getSpell().is(SpellTags.magic);
        }

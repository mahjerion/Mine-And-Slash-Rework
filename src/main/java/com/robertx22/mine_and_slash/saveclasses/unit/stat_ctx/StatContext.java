...
public abstract class StatContext {
    ...
    public enum StatCtxType {
        GEAR, PASSIVES, INNATE_SPELL, SUPPORT_GEM, BASE_STAT, ENCHANT_COMPAT, PROPHECY_CURSE, NEWBIE_RESISTS, JEWEL, VANILLA_STAT_COMPAT,
        BONUS_XP_PER_CHARACTER, COMMAND_EXACT_STATS, STAT_POINTS, TALENT, ASCENDANCY, ATLAS, POTION_EFFECT, AURA, MISC, MOB_AFFIX, FOOD_BUFF, TOOL,
        STAT_CTX_MODIFIER_BONUS, ITEM_SET
    }
}

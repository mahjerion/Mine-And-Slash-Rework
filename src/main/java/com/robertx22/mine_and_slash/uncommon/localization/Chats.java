...
public enum Chats implements IAutoLocName {
    ...
    MAP_EXPLORATION_RARITY("%1$s Exploration %2$s"),
    ...
    CORRUPT_CANT_BE_MODIFIED("Corrupted Items can't be modified. They can only be socketed with Gems etc."),
    MIRRORED_CANT_BE_MODIFIED("Mirrored Items can't be modified. They can only be socketed with Gems etc."),
    ...
    PROPHECY_NOT_ACTIVE_THIS_MAP("You must find and use a Prophecy Altar in this Map (if available) before you can reroll Prophecy Rewards"),
    ...
    PROPHECY_MAX_CURSES("You already carry the maximum number of Prophecy Curses. The altar crumbles without granting one, but your Prophecy Rewards are still available from the Hub."),
    ...
    CHARACTER_LOAD_INFO("Character Feature saves:\n- Your level and exp\n- Your spells, stats, talents, hotbar setup\n- Your equipped Armor, Offhand, Rings, Necklace and Omen\n- Your socketed Support Gems, Aura Gems and Jewels\n\nEquipped gear and socketed gems are stored with the character and come back when you load it.\n\nIt does not save your inventory, weapon or backpack.\n\nEach Character starts from Level 1"),
    ...
    MAP_DEVICE_RELICS_RETURNED("Your Relics were returned to you."),

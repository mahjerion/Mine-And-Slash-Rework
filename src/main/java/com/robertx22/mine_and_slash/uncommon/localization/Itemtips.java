...
public enum Itemtips implements IAutoLocName {
    ...
    SOUL_MODIFIER_TIP("Soul modifier can be applied to gear souls,\nmaking the souls generate only gear of that type.\n\nFor example you can make an armor soul create only Cloth items.\nOnly works on armors!"),
    ...
    BOUND_TO("Bound to %1$s"),
    BOUND_TO_OTHER("Bound to %1$s - grants you no stats");

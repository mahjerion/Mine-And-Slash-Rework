...
public enum Words implements IAutoLocName {
    ...
    REROLL_PROPHECY_OFFERS("Reroll Reward Offers"),
    PROPHECY_REROLLS_REMAINING("Rerolls Remaining: %1$s/%2$s"),
    PROPHECY_NOT_ACTIVE_THIS_MAP("Prophecy Not Currently Active"),
    ...
    Salvaging("Salvaging"),
    SalvagePrevPage("< Prev"),
    SalvageNextPage("Next >"),
    SalvageBack("Back"),
    MapLayouts("Map Layouts"),
    SkillGem("Skill Gem"),
    Hotbar("Spell Hotbar"),
    Gear("Gear"),
    ...
    MAP_DEVICE_INITIATE("Initiate Map"),
    MAP_DEVICE_JOIN("Join Map"),
    MAP_DEVICE_SLOT_MAP_HINT("Click to place a Map"),
    MAP_DEVICE_SLOT_RELIC_HINT("Click to place a Relic"),
    MAP_DEVICE_RIGHT_CLICK_RETURN("Right-Click to take it back"),
    MAP_DEVICE_RELIC_STATS("Relic Bonuses"),
    MAP_DEVICE_NO_MAP("Place a Map in the slot first"),
    MAP_DEVICE_FREE_RUN("A free run is ready to start"),
    MAP_DEVICE_EXIT("Exit"),
    MAP_DEVICE_RELIC_USES("%1$s Relic - %2$s"),
    ...
    Mercenary("Mercenary"),
    MercenaryOwnedName("%1$s's %2$s Mercenary"),
    MercenaryClassPrev("Previous Mercenary"),
    MercenaryClassNext("Next Mercenary"),
    MercenaryToggle("Mercenary"),
    MercenaryToggleTip("Turn your Mercenary off to dismiss it entirely. Its gear, level and skills are kept, and it returns when you turn it back on."),
    MercenaryCombatMode("Combat Mode"),
    MercenaryModeAggressiveTip("Attacks any hostile in range, and prioritises whatever you are fighting."),
    MercenaryModeDefensiveTip("Only fights back against things that strike you or your mercenary."),
    MercenaryModeIdleTip("Follows you and stays out of every fight."),
    MercenarySpirit("Spirit"),
    MercenarySpiritTip("Aura gems reserve Spirit. Your mercenary gains more as it levels."),
    MercenaryEmptySkill("Empty Skill Slot"),
    ...
    MercenaryPriorityTip("Skills are cast in order, left to right. Shift click to move this one earlier."),
    MercenaryNotSummoned("Your mercenary is not out right now."),
    MercenaryOffence("Offense"),
    MercenaryDefence("Defense"),
    MercenaryLevel("Lv. %1$s"),

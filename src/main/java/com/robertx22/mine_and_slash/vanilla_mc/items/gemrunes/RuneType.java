...
public enum RuneType {
    ...
    NET(300, "net", "Net", 1, 0.15f, () -> StatPerType.of()
            .addArmor(new ElementalResist(Elements.Fire).mod(3, 6))
            .addJewerly(new ElementalResist(Elements.Fire).mod(3, 6))
            .addWeapon(OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Fire).mod(1, 5))
    ),
    UND(300, "und", "Und", 2, 0.3f, () -> StatPerType.of()
            .addArmor(new ElementalResist(Elements.Cold).mod(3, 6))
            .addJewerly(new ElementalResist(Elements.Cold).mod(3, 6))
            .addWeapon(OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Cold).mod(1, 5))
    ),
    BRI(300, "bri", "Bri", 3, 0.4f, () -> StatPerType.of()
            .addArmor(new ElementalResist(Elements.Nature).mod(3, 6))
            .addJewerly(new ElementalResist(Elements.Nature).mod(3, 6))
            .addWeapon(OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Nature).mod(1, 5))
    ),
    DAW(300, "daw", "Daw", 3, 0.4f, () -> StatPerType.of()
            .addArmor(new ElementalResist(Elements.Shadow).mod(3, 6))
            .addJewerly(new ElementalResist(Elements.Shadow).mod(3, 6))
            .addWeapon(OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Fire).mod(1, 5))
    ),
